...
//import processSingleRequest1 from '@salesforce/apex/NGMCP_UserManagmentController.createUser1';
...
export default class NGMCP_PortalUserManagement extends LightningElement {
    /* ===================== UI OPTIONS ===================== */
    actionOptions = [
        ...
        const tasks = files.map(async (file) => {
            ...
            if (isCsv) {
                ...
                try {
                    ...
                    console.error('CSV parse/validation failed:', file.name, err);
                ...
                try {
                    ...
                    // eslint-disable-next-line no-console
                    console.error('Failed reading file as DataURL:', file.name, err);
